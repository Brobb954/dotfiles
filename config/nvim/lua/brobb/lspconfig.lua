...
return {
  ...
  config = function()
    ...
    local on_init = require("brobb.lsp").on_init
    local capabilities = require("brobb.lsp").capabilities
    local create_on_attach = require("brobb.lsp").create_on_attach
    local inlay_hints_settings = require("brobb.lsp").inlay_hints_settings
